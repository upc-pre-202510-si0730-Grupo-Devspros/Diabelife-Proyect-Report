...
|----------------------------------------------------------------------------------------------------------------------------|-------------------|-|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| Mamani Marca, Gabriel Cristian <br><img src="../assets/GabrielMamani.png" alt="Imagen del compañero" style="width:60%;">   | u202220659        |Ingenieria de software| Soy estudiante de sexto ciclo de la carrera de Ingeniería de Software.Durante el camino aprendi lenguajes como c++,python y java.Tambien,sobre motores de base de datos como MongoDb y MYSQL                                                                                                                                                                                                                                                                                             |
...
| Espinoza Cueva, Stephano Jose <br><img src="../assets/StephanoEspinoza.jpg" alt="Imagen del compañero" style="width:60%;"> | u202218590        |Ingenieria de software| Soy estudiante de sexto ciclo de la carrera de Ingenieria de Software en la Universidad Peruana de Ciencias Aplicadas. Soy una persona responsable y con un buen trabajo en grupo, me gusta mucho lo que es el FrontEnd y base de datos, tengo conocimientos en Angular, React y ahora quiero aprender lo que es vue y con respecto a base de datos se MySql y Mongodb.                                                                                                                  | Véliz Martinez, Diego Alonso <br><img src="../assets/DiegoVeliz.PNG" alt="Imagen del compañero" style="width:60%;">                       | u20211b564         | Ingenieria de software     | Soy estudiante de la carrera de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas. Me apasiona el desarrollo de soluciones tecnológicas que generen impacto real en las personas. Tengo conocimientos en desarrollo web (HTML, CSS, JavaScript, React), bases de datos relacionales (MySQL) y no relacionales (MongoDB), Soy responsable y sé trabjar en equipo.                                |
